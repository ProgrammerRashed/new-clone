!(function () {
      ...
      (n.prototype.THROTTLE_TIMEOUT = 100),
        ...
        (n.prototype._checkForIntersections = function () {
          ...
          this._observationTargets.forEach(function (n) {
            var s = n.element,
              ...
              u = n.entry,
              c = e && l && this._computeTargetAndRootIntersection(s, i),
              h = (n.entry = new r({
        ...
        (n.prototype._computeTargetAndRootIntersection = function (i, r) {
          if ("none" != t.getComputedStyle(i).display) {
            for (var n, s, o, l, c, h, f, p, d = a(i), _ = u(i), m = !1; !m; ) {
              var g = null,
                v = 1 == _.nodeType ? t.getComputedStyle(_) : {};
              ...
              if (
                ...
                g &&
                  ...
                  (f = void 0),
                  (p = void 0),
                  (o = Math.max(n.top, s.top)),
                  (l = Math.min(n.bottom, s.bottom)),
      ...
      value: function (t) {
        ...
        for (var e = Object(t), i = 1; i < arguments.length; i++) {
          ...
          if (null != r) {
            r = Object(r);
            for (
              var n = Object.keys(Object(r)), s = 0, o = n.length;
              s < o;
              s++
            ) {
              var a = n[s],
   ...
   * Copyright (c) 2019 Apoorv Saxena; Licensed MIT */ (function (t, e) {
      ...
      e = {
        ...
        load: function (e) {
          ...
          if (
            ...
            for (var r = e.children, n = void 0, s = 0; s <= r.length - 1; s++)
              (n = r[s].getAttribute("data-src")) && (r[s].src = n);
            e.load();
          }
          if (
            ...
            var o = e.getAttribute("data-background-image-set").split(","),
              ...
              return function (n, s) {
                n.forEach(function (n) {
                  (n.intersectionRatio > 0 || n.isIntersecting) &&
                    ...
                    r(n.target) || (t(n.target), i(n.target), e(n.target)));
                });
              };
            })(u, c),
            { root: o, rootMargin: a, threshold: l }
          )),
        {
          observe: function () {
            for (
              ...
              r(e[n]) || (h ? h.observe(e[n]) : (u(e[n]), i(e[n]), c(e[n])));
          },
  ...
  (function (t) {
    var e,
      ...
      n = !1,
      s = !1,
      o = { interval: 100, force_process: !1, support_seamless_iframes: !1 },
      a = t(window),
      l = !1,
      u = [];
    function c() {
      ...
      for (var e = 0, i = r.length; e < i; e++) {
        var n = t(r[e]).filter(function () {
          return t(this).is(":appeared");
        });
        if ((n.trigger("appear", [n]), u[e])) {
          var o = u[e].not(n);
    ...
    (t.expr[":"].appeared = function (r) {
      ...
      if (
        ...
        if (1 === n.data("ut-wait"))
          return (
            n.data("ut-remove-wait") &&
              !wait_timer &&
              ((s = n),
              (wait_timer = setTimeout(function () {
                s.data("ut-wait", 0), (wait_timer = !1);
              }, s.data("ut-remove-wait")))),
            !1
          );
        var s;
        if (window.ut_global_wait) return !1;
        if (
          n.hasClass("ut-element-revealer") &&
          1 === n.parent(".ut-element-revealer-parent").length &&
          1 ===
            n
              .parent()
              .parent(
                ".ut-element-revealer-parent:not(.ut-element-revealer-in-back-parent):not(.ut-element-revealer-ready)"
              ).length
        )
          return !1;
        if (
          n.hasClass("ut-element-revealer") &&
          1 === n.parent().closest(".ut-element-revealer-parent").length &&
          1 ===
            n
              .parent()
              .parent()
              .closest(
                ".ut-element-revealer-parent:not(.ut-element-revealer-ready)"
              ).length
        )
          return !1;
        if (
        ...
        var o = a.scrollLeft(),
          ...
          d = f.top;
        if (l) {
          var _ = t(window.top).scrollTop(),
            m = _ + t(window.top).height(),
            g = t(window.top).scrollLeft(),
            v = g + t(window.top).width(),
            y = i.top,
            w = y + e.height(),
            b = i.left,
            x = b + e.width();
          if (_ > w || y > m || g > x || b > v) return !1;
          _ > y && (c += _ - y),
            w > m && (h -= w - m),
            g > b && (o += g - b),
            x > v && (u -= x - v);
        ...
        return (
          d + n.height() >= c &&
          d - (n.data("appear-top-offset") || 0) <= h &&
          p + n.width() >= o &&
          p - (n.data("appear-left-offset") || 0) <= u
        );
      }
    }),
      t.fn.extend({
        appear: function (a) {
          ...
          if (!n) {
            var p = function () {
              s || ((s = !0), setTimeout(c, h.interval));
            };
            h.support_seamless_iframes &&
              window.frameElement &&
              ((e = t(window.frameElement)),
              (l = "no" === e.attr("scrolling") || e.is("[seamless]"))),
              l
                ? ((i = e.offset()), t(window.top).scroll(p).resize(p))
                : t(window).scroll(p).resize(p),
              (n = !0);
          }
          return (
            h.force_process && setTimeout(c, h.interval),
            (function (t) {
              r.push(t), u.push();
            })(f),
            t(f)
  ...
  (function (t) {
    ...
    var e,
      ...
      s = document,
      o = window,
      a = (t(o), s.documentElement),
      l = !1;
    function u(t) {
      l = setTimeout(function () {
        t.data("ut-wait", 0), (l = !1);
    ...
    function c() {
      if (
        ...
        for (
          e =
            e ||
            ((h = { height: o.innerHeight, width: o.innerWidth }).height ||
              (!(r = s.compatMode) && t.support.boxModel) ||
              (h = {
                height: (c = "CSS1Compat" === r ? a : s.body).clientHeight,
                width: c.clientWidth,
              }),
            h),
            i = i || { top: o.pageYOffset || a.scrollTop || s.body.scrollTop };
          f < n.length;
          f++
        )
          if (t.contains(a, p[f][0])) {
            var d = t(p[f]),
              _ = { height: d[0].offsetHeight, width: d[0].offsetWidth },
              m = d.offset(),
              g = d.data("appear-top-offset"),
              v = d.data("inview");
            if (d.is(":visible"))
              if (
                (d.hasClass("ut-has-background-video"), 1 !== d.data("ut-wait"))
              ) {
                if (!window.ut_global_wait) {
                  if (!i || !e) return;
                  void 0 !== g && "full" === g && _.height < e.height
                    ? m.top >= i.top && m.top + _.height <= i.top + e.height
                      ? v || d.data("inview", !0).trigger("inview", [!0])
                      : v && d.data("inview", !1).trigger("inview", [!1])
                    : (void 0 === g || "none" !== g || v || (g = 0),
                      void 0 === g || "auto" !== g || v || (g = 0.5 * _.height),
                      void 0 === g ||
                        "almost" !== g ||
                        v ||
                        (g = 0.75 * _.height),
                      void 0 === g ||
                        ...
                        v ||
                        (g = 0.33 * _.height),
                      ((void 0 !== g && "auto" === g && v) || void 0 === g) &&
                        (g = 0),
                      (g = -Math.abs(g)),
                      m.top + _.height >= i.top &&
                      m.top - (g || 0) <= i.top + e.height
                        ? v || d.data("inview", !0).trigger("inview", [!0])
                        : v && d.data("inview", !1).trigger("inview", [!1]));
                }
              } else d.data("ut-remove-wait") && !l && u(d);
            else d.data("inview", !1).trigger("inview", [!1]);
          }
      }
    }
    (t.event.special.inview = {
      add: function (e) {
        n.push({ data: e, $element: t(this), element: this }),
          !r && n.length && (r = setInterval(c, 100));
      },
      remove: function (t) {
        ...
        n.length || (clearInterval(r), (r = null));
      },
    }),
    ...
    (t.waitForImages = {
      ...
      (t.fn.waitForImages = function () {
        var e,
          ...
          f = t.waitForImages.hasImageAttributes || [],
          p = /url\(\s*(['"]?)(.*?)\1\s*\)/g;
        if (
          (t.isPlainObject(arguments[0])
            ? ((o = arguments[0].waitForAll),
              (s = arguments[0].each),
              (n = arguments[0].finished))
            : 1 === arguments.length && "boolean" === t.type(arguments[0])
            ? (o = arguments[0])
            : ((n = arguments[0]), (s = arguments[1]), (o = arguments[2])),
          (n = n || t.noop),
          (s = s || t.noop),
          (o = !!o),
          !t.isFunction(n) || !t.isFunction(s))
        )
        ...
        return (
            ...
            o
              ? e
                  ...
                  .each(function () {
                    ...
                    e.is("img:has-src") &&
                      !e.is("[srcset]") &&
                      c.push({ src: e.attr("src"), element: e[0] }),
                      t.each(h, function (t, i) {
                        var r,
                          n = e.css(i);
                        if (!n) return !0;
                        for (; (r = p.exec(n)); )
                          c.push({ src: r[2], element: e[0] });
                      }),
          ...
          (e = c.length),
          (a = 0),
          0 === e && (n.call(u), l.resolveWith(u)),
          t.each(c, function (o, c) {
            var h = new Image(),
              f = "load." + i + " error." + i;
            t(h).one(f, function i(r) {
              var o = [a, e, "load" == r.type];
              if (
                (a++,
                s.apply(c.element, o),
                l.notifyWith(c.element, o),
                t(this).off(f, i),
                a == e)
              )
                return n.call(u[0]), l.resolveWith(u[0]), !1;
            }),
              r && c.srcset && ((h.srcset = c.srcset), (h.sizes = c.sizes)),
              (h.src = c.src);
          }),
          l.promise()
        );
  ...
  (function (t, e) {
    "function" == typeof define && define.amd
      ? (H, define("ev-emitter/ev-emitter", e))
  ...
  (function (t) {
    ...
    var s = function (e, i) {
      return (
        t.keyframe.debug && console.log(e + " " + i),
        t("<style>" + i + "</style>")
      ...
      generate: function (e) {
        ...
        for (var a in e)
          if ("name" !== a && "media" !== a && "complete" !== a) {
            for (var l in ((o += a + " {"), e[a])) o += l + ":" + e[a][l] + ";";
            o += "}";
          }
        window.PrefixFree ? (o = PrefixFree.prefixCSS(o + "}")) : (o += "}"),
          e.media && (o = "@media " + e.media + "{" + o + "}");
    ...
    (t.fn.resetKeyframe = function (e) {
      ...
      (t.fn.playKeyframe = function (e, i) {
        ...
        if (t.isArray(e)) {
          for (var l = [], u = 0; u < e.length; u++)
            "string" == typeof e[u] ? l.push(e[u]) : l.push(n(e[u]));
          s = l.join(", ");
        ...
        return (
          this.each(function () {
            ...
            if (t.keyframe.debug) {
              console.group(),
                r && console.log("Vendor Prefix: " + r),
                console.log("Style Applied: " + s);
              var l = n.css(c);
              console.log("Rendered Style: " + (l || n[0].style.animation)),
                console.groupEnd();
            }
            i && (f(n, "AnimationIteration", i), f(n, "AnimationEnd", i));
          }),
          this
        );
      }),
      s(
        "boost-keyframe",
        " .boostKeyframe{" + r + "transform:scale3d(1,1,1);}"
      );
  })(jQuery),
  ...
  (function (t, e, i) {
    ...
    var o = {},
      ...
      v =
        /rident/.test(g) ||
        (/ecko/.test(g) && g.match(/rv\:(\d+)/) && RegExp.$1 > 35),
      y = "currentSrc",
      w = /\s+\+?\d+(e\d+)?w/,
      b = /(\([^)]+\))?\s*(.+)/,
      x = t.picturefillCFG,
    ...
    var B,
      ...
      J =
        ...
        function (t, e) {
          var i;
          if (!(t in S))
            if (((S[t] = !1), e && (i = t.match(B)))) S[t] = i[1] * O[i[2]];
            else
              try {
                S[t] = new Function("e", X(t))(O);
              } catch (t) {}
          return S[t];
        }),
      tt = function (t, e) {
        return (
          t.w
            ? ((t.cWidth = o.calcListLength(e || "100vw")),
              (t.res = t.w / t.cWidth))
            : (t.res = t.d),
          t
        );
      ...
      et = function (t) {
        ...
        if (
          ...
          (n = (i =
            ...
            o.qsa(
              s.context || e,
              s.reevaluate || s.reselect ? o.sel : o.selShort
            )).length))
        ) {
          for (o.setupRun(s), R = !0, r = 0; r < n; r++) o.fillImg(i[r], s);
          o.teardownRun(s);
        }
      };
    function it(t, e) {
    ...
    function rt(t, e) {
      var i, r, n;
      if (t && e)
        for (n = o.parseSet(e), t = o.makeUrl(t), i = 0; i < n.length; i++)
          if (t === o.makeUrl(n[i].url)) {
            r = n[i];
            break;
          }
      return r;
    ...
    t.console && console.warn,
      ...
      (p["image/gif"] = !0),
      (p["image/png"] = !0),
      (p["image/svg+xml"] = e.implementation.hasFeature(
        "http://wwwindow.w3.org/TR/SVG11/feature#Image",
        "1.1"
      )),
      (o.ns = ("pf" + new Date().getTime()).substr(0, 9)),
      (o.supSrcset = "srcset" in l),
      (o.supSizes = "sizes" in l),
      (o.supPicture = !!t.HTMLPictureElement),
      o.supSrcset &&
        o.supPicture &&
        !o.supSizes &&
        ...
        (l.srcset = "data:,a"),
        (q.src = "data:,a"),
        (o.supSrcset = l.complete === q.complete),
        (o.supPicture = o.supSrcset && o.supPicture)),
      (o.selShort = "picture>img,img[srcset]"),
      (o.sel = o.selShort),
      (o.cfg = d),
      o.supSrcset && (o.sel += ",img[" + m + "]"),
      (o.DPR = k || 1),
      (o.u = O),
      (o.types = p),
      (n = o.supSrcset && !o.supSizes),
      (o.setSize = a),
      (o.makeUrl = j(function (t) {
        return (C.href = t), C.href;
      })),
      (o.qsa = function (t, e) {
      ...
      (o.parseSize = j(function (t) {
        var e = (t || "").match(b);
        return { media: e && e[1], length: e && e[2] };
      })),
      (o.parseSet = function (t) {
        return (
          t.cands ||
            (t.cands = (function (t, e) {
              function i(e) {
                var i,
                  r = e.exec(t.substring(u));
                if (r) return (i = r[0]), (u += i.length), i;
              }
              var r,
                n,
                s,
              ...
              function f() {
                for (i(E), s = "", o = "in descriptor"; ; ) {
                  if (((a = t.charAt(u)), "in descriptor" === o))
                    if (N(a))
                      s && (n.push(s), (s = ""), (o = "after descriptor"));
                    else {
                      if ("," === a) return (u += 1), s && n.push(s), void h();
                      if ("(" === a) (s += a), (o = "in parens");
                      else {
                        if ("" === a) return s && n.push(s), void h();
                        s += a;
                      }
                    }
                  else if ("in parens" === o)
            ...
            (function (t) {
              ...
              for (
                r = (i = (function (t) {
                  ...
                  for (;;) {
                    ...
                    if (a) {
                      ...
                      if (N(e)) {
                        if ((t.charAt(o - 1) && N(t.charAt(o - 1))) || !i) {
                          o += 1;
                          continue;
                        }
                        if (0 === s) {
                ...
                if (
                  ...
                  if (((n = n.join(" ")), o.matchesMedia(n))) return a;
                }
              return "100vw";
            })(t)
          );
      ...
      (o.setRes = function (t) {
        var e;
        if (t)
          for (var i = 0, r = (e = o.parseSet(t)).length; i < r; i++)
            tt(e[i], t.sizes);
        return e;
      }),
      (o.setRes.res = tt),
      (o.applySetCandidate = function (t, e) {
        if (t.length) {
          var i,
            r,
            n,
          ...
          if (
            ...
            (u =
              ...
              (function (t, e, i) {
                var r;
                return (
                  !i && e && (i = (i = t[o.ns].sets) && i[i.length - 1]),
                  (r = rt(e, i)) &&
                    ((e = o.makeUrl(e)),
                    (t[o.ns].curSrc = e),
                    (t[o.ns].curCan = r),
                    r.res || tt(r, r.set.sizes)),
                  r
                );
              })(e, l, t[0].set)),
            u &&
              u.set === t[0].set &&
              ((h = v && !e.complete && u.res - 0.1 > T) ||
                ((u.cached = !0), u.res >= T && (a = u))),
            !a)
          )
            for (t.sort(it), a = t[(s = t.length) - 1], r = 0; r < s; r++)
              if ((i = t[r]).res >= T) {
                a =
                  t[(n = r - 1)] &&
                  (h || l !== o.makeUrl(i.url)) &&
                  ...
                  "saveData" === d.algorithm
                    ? f > 2.7
                      ? (b = _ + 1)
                      : ((w = (p - _) * (g = Math.pow(f - 0.6, 1.5))),
                        m && (w += 0.1 * g),
                        (b = f + w))
                    : (b = _ > 1 ? Math.sqrt(f * p) : f),
                  b > _)
                    ? t[n]
                    : i;
                break;
      ...
      (o.parseSets = function (t, e, r) {
        var s,
          a,
          l,
          f,
          p = e && "PICTURE" === e.nodeName.toUpperCase(),
          d = t[o.ns];
        (d.src === i || r.src) &&
          ((d.src = u.call(t, "src")),
          d.src ? c.call(t, _, d.src) : h.call(t, _)),
          (d.srcset === i || r.srcset || !o.supSrcset || t.srcset) &&
            ((s = u.call(t, "srcset")), (d.srcset = s), (f = !0)),
          (d.sets = []),
          p &&
            ((d.pic = !0),
            (function (t, e) {
          ...
          d.srcset
            ? ((a = { srcset: d.srcset, sizes: u.call(t, "sizes") }),
              d.sets.push(a),
              (l = (n || d.src) && w.test(d.srcset || "")) ||
                !d.src ||
                rt(d.src, a) ||
                a.has1x ||
                ((a.srcset += ", " + d.src),
                a.cands.push({ url: d.src, d: 1, set: a })))
            : d.src && d.sets.push({ srcset: d.src, sizes: null }),
          (d.curCan = null),
          (d.curSrc = i),
          (d.supported = !(p || (a && !o.supSrcset) || l)),
          f &&
            o.supSrcset &&
            !d.supported &&
            (s ? (c.call(t, m, s), (t.srcset = "")) : h.call(t, m)),
          d.supported &&
            !d.srcset &&
            ((!d.src && t.src) || t.src !== o.makeUrl(d.src)) &&
            (null === d.src ? t.removeAttribute("src") : (t.src = d.src)),
          (d.parsed = !0);
      }),
      (o.fillImg = function (t, e) {
        var i,
          r,
          n,
          a,
          l,
          u = e.reselect || e.reevaluate;
        (t[o.ns] || (t[o.ns] = {}), (i = t[o.ns]), u || i.evaled !== s) &&
          ((i.parsed && !e.reevaluate) || o.parseSets(t, t.parentNode, e),
          i.supported
            ? (i.evaled = s)
            : ((r = t),
              (a = o.getSet(r)),
              (l = !1),
              "pending" !== a &&
                ((l = s), a && ((n = o.setRes(a)), o.applySetCandidate(n, r))),
              (r[o.ns].evaled = l)));
      }),
      (o.setupRun = function () {
        (R && !A && k === t.devicePixelRatio) ||
          ((A = !1),
          (k = t.devicePixelRatio),
          (S = {}),
          (P = {}),
          (o.DPR = k || 1),
          (O.width = Math.max(t.innerWidth || 0, f.clientWidth)),
          (O.height = Math.max(t.innerHeight || 0, f.clientHeight)),
          (O.vw = O.width / 100),
          (O.vh = O.height / 100),
          (s = [O.height, O.width, k].join("-")),
          (O.em = o.getEmValue()),
          (O.rem = O.em));
      }),
      o.supPicture
        ? ((et = a), (o.fillImg = a))
        : (($ = t.attachEvent ? /d$|^c/ : /d$|^c|^i/),
          (G = function () {
            var t = e.readyState || "";
            (Z = setTimeout(G, "loading" === t ? 200 : 999)),
              e.body && (o.fillImgs(), (U = U || $.test(t)) && clearTimeout(Z));
          }),
          (Z = setTimeout(G, e.body ? 9 : 99)),
          (K = f.clientHeight),
          L(
            t,
            "resize",
            ((W = function () {
              (A =
                Math.max(t.innerWidth || 0, f.clientWidth) !== O.width ||
                f.clientHeight !== K),
                (K = f.clientHeight),
                A && o.fillImgs();
            }),
            ...
            (H = function () {
              var t = new Date() - V;
              t < Q ? (Y = setTimeout(H, Q - t)) : ((Y = null), W());
            }),
            function () {
              (V = new Date()), Y || (Y = setTimeout(H, Q));
            })
          ),
          L(e, "readystatechange", G)),
      (o.picturefill = et),
      (o.fillImgs = et),
      (o.teardownRun = a),
      (et._ = o),
      (t.picturefillCFG = {
        ...
        push: function (t) {
          ...
          "function" == typeof o[e]
            ? o[e].apply(o, t)
            : ((d[e] = t[0]), R && o.fillImgs({ reselect: !0 }));
        },
      });
  ...
  (function (t) {
    ...
    "use strict";
    var e = (t.scrollTo = function (e, i, r) {
    ...
    return (
        ...
        return (
          ...
          this.each(function () {
            if (null !== n) {
              ...
              var d = (t.isFunction(o.offset) && o.offset(c, f)) || o.offset;
              t.each(o.axis.split(""), function (t, i) {
                var r = "x" === i ? "Left" : "Top",
                  ...
                  g = e.max(c, i);
                if (l)
                  (p[s] = l[n] + (u ? 0 : m - h.offset()[n])),
                    o.margin &&
                      ((p[s] -= parseInt(f.css("margin" + r), 10) || 0),
                      (p[s] -=
                        parseInt(f.css("border" + r + "Width"), 10) || 0)),
                    (p[s] += d[n] || 0),
                    o.over[n] &&
                      (p[s] += f["x" === i ? "width" : "height"]() * o.over[n]);
                else {
                  var v = f[n];
                  p[s] =
                    v.slice && "%" === v.slice(-1)
                ...
                o.limit &&
                  /^\d+$/.test(p[s]) &&
                  (p[s] = p[s] <= 0 ? 0 : Math.min(p[s], g)),
                  !t &&
                    o.axis.length > 1 &&
                    (m === p[s]
                      ? (p = {})
                      : a && (_(o.onAfterFirst), (p = {})));
              }),
                _(o.onAfter);
            }
            function _(e) {
      ...
      (e.max = function (e, r) {
        var n = "x" === r ? "Width" : "Height",
          s = "scroll" + n;
        if (!i(e)) return e[s] - t(e)[n.toLowerCase()]();
        var o = "client" + n,
      ...
      return t
        ? this.on(
            ...
            function () {
              var t = this,
                e = arguments;
              s ? clearTimeout(s) : n && i.apply(t, e),
    ...
    t.extend(t.easing, {
      ...
      easeInOutElastic: function (t) {
        return 0 === t
          ...
          ? 1
          : t < 0.5
          ? (-e(2, 20 * t - 10) * r((20 * t - 11.125) * c)) / 2
          : (e(2, -20 * t + 10) * r((20 * t - 11.125) * c)) / 2 + 1;
      },
      easeInBack: function (t) {
        return l * t * t * t - o * t * t;
      },
      easeOutBack: function (t) {
        return 1 + l * e(t - 1, 3) + o * e(t - 1, 2);
      },
    ...
    (t.fn.lazyload = function (s) {
      ...
      return (
        s &&
          ...
          t.extend(l, s)),
        (o = l.container === r || l.container === e ? n : t(l.container)),
        0 === l.event.indexOf("scroll") &&
          o.on(l.event, function () {
            return u();
          }),
        this.each(function () {
          var e = this,
      ...
      (e = function (t, e) {
        ...
        return (
          ...
          (s = (function () {
                ...
                i.on(d, function () {
                  ...
                  if (!r.didResize)
                    return (
                      (r.didResize = !0),
                      (i = function () {
                        return t[y]("refresh"), (r.didResize = !1);
                      }),
            ...
            return (
                ...
                return (
                  ...
                  t.each(e, function (e, r) {
                    ...
                    return (
                      ...
                      t.each(i.waypoints[e], function (t, e) {
                        var i, n;
                        return (r.oldScroll < (i = e.offset) &&
                          i <= r.newScroll) ||
                          (r.newScroll < (n = e.offset) && n <= r.oldScroll)
                          ? o.push(e)
                          : void 0;
                      }),
                      o.sort(function (t, e) {
              ...
              (i.prototype.refresh = function () {
                ...
                return (
                  ...
                  t.each(e, function (e, i) {
                    return t.each(n.waypoints[e], function (e, r) {
                      var n, s, o, a, l;
                      if (
                        ((n = r.options.offset),
                        (o = r.offset),
                        (s = t.isWindow(r.element)
                          ? 0
                          : r.$element.offset()[i.offsetProp]),
                        t.isFunction(n)
                          ? (n = n.apply(r.element))
                          : "string" == typeof n &&
                            ((n = parseFloat(n)),
                        ...
                        (r.offset = s - i.contextOffset + i.contextScroll - n),
                        (!r.options.onlyOnScroll || null == o) && r.enabled)
                      )
                        return null !== o &&
                          o < (a = i.oldScroll) &&
                          a <= r.offset
                          ? r.trigger([i.backward])
                          : (null !== o &&
                              o > (l = i.oldScroll) &&
                              l >= r.offset) ||
                            (null === o && i.oldScroll >= r.offset)
                          ? r.trigger([i.forward])
                          : void 0;
                    });
                  })
              ...
              (i.prototype.checkEmpty = function () {
                if (
                  t.isEmptyObject(this.waypoints.horizontal) &&
                  t.isEmptyObject(this.waypoints.vertical)
                )
                  return (
                    this.$element.unbind([d, _].join(" ")), delete c[this.id]
                  );
              }),
              i
            );
            ...
            function e(e, i, r) {
              ...
              "bottom-in-view" === r.offset &&
                (r.offset = function () {
                  var e;
                  return (
                    (e = t[y]("viewportHeight")),
                    t.isWindow(i.element) || (e = i.$element.height()),
                ...
                (n = null != (s = this.element[g]) ? s : []).push(this.id),
                (this.element[g] = n);
            }
            return (
              ...
              (e.getWaypointsByElement = function (e) {
                var i, r;
                return (r = e[g])
                  ? ((i = t.extend({}, a.horizontal, a.vertical)),
                    t.map(r, function (t) {
                      return i[t];
                    }))
                  : [];
          ...
          (p = {
            init: function (e, i) {
              return (
                null == (i = t.extend({}, t.fn[v].defaults, i)).handler &&
                  (i.handler = e),
                this.each(function () {
                  var e, r, n, a;
                  return (
                    (e = t(this)),
                    (n =
                      null != (a = i.context) ? a : t.fn[v].defaults.context),
                    t.isWindow(n) || (n = e.closest(n)),
                    (n = t(n)),
                    (r = c[n[0][u]]) || (r = new s(n)),
                    new o(e, r, i)
                  );
            ...
            _traverse: function (i, r, n) {
              ...
              return (
                ...
                this.each(function () {
                  var e;
                  return (e = t.inArray(this, o[i])), n(s, e, o[i]);
                }),
                this.pushStack(s)
              );
            },
            _invoke: function (e) {
              return (
                this.each(function () {
                  var i;
                  return (
                    (i = o.getWaypointsByElement(this)),
          ...
          (f = {
            ...
            viewportHeight: function () {
              var t;
              return null != (t = e.innerHeight) ? t : n.height();
            },
            aggregate: function (e) {
              var i, r, n;
              return (
                (i = a),
                e && (i = null != (n = c[t(e)[0][u]]) ? n.waypoints : void 0),
                i
                  ? ((r = { horizontal: [], vertical: [] }),
                    t.each(r, function (e, n) {
                      return (
                        t.each(i[e], function (t, e) {
                          return n.push(e);
                        }),
                        n.sort(function (t, e) {
                          return t.offset - e.offset;
                        }),
                        (r[e] = t.map(n, function (t) {
                          return t.element;
                        })),
                        (r[e] = t.unique(r[e]))
                      );
            ...
            above: function (t) {
              return (
                null == t && (t = e),
                f._filter(t, "vertical", function (t, e) {
            ...
            left: function (t) {
              return (
                null == t && (t = e),
                f._filter(t, "horizontal", function (t, e) {
            ...
            _invoke: function (e) {
              var i;
              return (
                (i = t.extend({}, a.vertical, a.horizontal)),
                t.each(i, function (t, i) {
                  return i[e](), !0;
                })
              );
            },
            _filter: function (e, i, r) {
              var n, s;
              return (n = c[t(e)[0][u]])
                ? ((s = []),
                  t.each(n.waypoints[i], function (t, e) {
          ...
          (t[y] = function () {
            ...
            return (
              ...
              f[e] ? f[e].apply(null, t) : f.aggregate.call(null, e)
            );
          }),
          (t[y].settings = { resizeThrottle: 100, scrollThrottle: 30 }),
  ...
  (function (t, e) {
    ...
    var i = function (r, n) {
      function s() {
        ...
        (this.add = function (t) {
          ...
          (this.remove = function (r) {
            var n = [];
            for (t = 0, e = i.length; t < e; t++) i[t] !== r && n.push(i[t]);
            i = n;
          }),
      ...
      function o(e, i) {
        ...
        } else (e.resizedAttached = new s()), e.resizedAttached.add(i);
        ...
        var o = e.resizeSensor.childNodes[0],
          a = o.childNodes[0],
        ...
        var c,
          ...
          _ = function () {
            e.resizedAttached &&
              (d && (e.resizedAttached.call(), (d = !1)), t(_));
          };
        t(_);
        var m = function () {
            ((f = e.offsetWidth) == c && (p = e.offsetHeight) == h) ||
              ((d = !0), (c = f), (h = p)),
              u();
          },
          g = function (t, e, i) {
  ...
  (function (t) {
      ...
      g =
        ...
        (p = function () {
          ...
          o
            ? t.proxy(d, e, i)()
            : (clearTimeout(i.sfTimer),
              (i.sfTimer = setTimeout(t.proxy(d, e, i), i.delay)));
        }),
        (d = function (e) {
          (e.retainPath = t.inArray(this[0], e.$path) > -1),
            this.superfish("hide"),
            this.parents("." + e.hoverClass).length ||
              (e.onIdle.call(_(this)), e.$path.length && t.proxy(f, e.$path)());
        }),
        (_ = function (t) {
          return t.closest("." + r);
        }),
        (m = function (t) {
          return _(t).data("sf-options");
        }),
        {
          hide: function (t) {
            if (this.length) {
          ...
          destroy: function () {
            return this.each(function () {
              var e,
                ...
                n = r.data("sf-options");
              if (!n) return !1;
              (e = r.find(n.popUpSelector).parent("li")),
                clearTimeout(n.sfTimer),
                l(r, n),
                u(e),
                c(r),
                r.off(".superfish").off(".hoverIntent"),
                e.children(n.popUpSelector).attr("style", function (t, e) {
                  return e.replace(/display[^;]+;?/g, "");
                }),
                n.$path
                  .removeClass(n.hoverClass + " " + i)
                  .addClass(n.pathClass),
                r.find("." + n.hoverClass).removeClass(n.hoverClass),
                n.onDestroy.call(r),
          ...
          init: function (e) {
            return this.each(function () {
              ...
              var n = t.extend({}, t.fn.superfish.defaults, e),
                s = r.find(n.popUpSelector).parent("li");
              (n.$path = (function (e, r) {
                return e
                  .find("li." + r.pathClass)
                  .slice(0, r.pathLevels)
                  .addClass(r.hoverClass + " " + i)
                  .filter(function () {
                    return t(this)
                ...
                (function (e, i) {
                  ...
                  t.fn.hoverIntent && !i.disableHI
                    ? e.hoverIntent(f, p, r)
                    : e
                        .on("mouseenter.superfish", r, f)
                        .on("mouseleave.superfish", r, p);
                  var n = "MSPointerDown.superfish";
                  o || (n += " touchend.superfish"),
    ...
    (t.fn.superfish = function (e, i) {
      ...
      t.fn.extend({ hideSuperfishUl: g.hide, showSuperfishUl: g.show });
  })(jQuery),
  /*!
   * FitVids 1.1
   *
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
  "use strict";
  var t, e, i, r, n, s, o, a, l, u, c, h, f, p, d, _;
  _gsScope._gsDefine(
    "TweenMax",
    ...
    function (t, e, i) {
          ...
          return function (t, u, c) {
            ...
            if (!b) {
              if (!(y = "auto" === e.grid ? 0 : (e.grid || [1 / 0])[0])) {
                for (
                  g = -1 / 0;
                  g < (g = c[y++].getBoundingClientRect().left) && w > y;
              ...
              for (
                ...
                (p = (m % y) - h),
                  (d = f - ((m / y) | 0)),
                  (b[m] = _ =
                    a ? Math.abs("y" === a ? d : p) : Math.sqrt(p * p + d * d)),
                  _ > g && (g = _),
                  v > _ && (v = _);
              (b.max = g - v),
                (b.min = v),
            ...
            return (
              (w = (b[t] - b.min) / b.max), b.b + (i ? i.getRatio(w) : w) * b.v
            );
          };
        },
        o = function (t, e, r) {
      ...
      (o.version = "2.1.3"),
        ...
        (h.updateTo = function (t, e) {
          ...
          if (n._initted || o)
            if (e) (n._initted = !1), o && n.render(0, !0, !0);
              ...
              for (var l, u = 1 / (1 - s), c = n._firstPT; c; )
                (l = c.s + c.c), (c.c *= u), (c.s = l - c.c), (c = c._next);
          return n;
        }),
        (h.render = function (t, e, r) {
          ...
          if (
            (t >= m - a && t >= 0
              ? ((_._totalTime = m),
                ...
                _._reversed ||
                  ((n = !0),
                  (s = "onComplete"),
                  (r = r || _._timeline.autoRemoveChildren)),
                0 === w &&
                  (_._initted || !_.vars.lazy || r) &&
                  (_._startTime === _._timeline._duration && (t = 0),
                  (0 > b ||
                    (0 >= t && t >= -a) ||
                    (b === a && "isPause" !== _.data)) &&
                    b !== t &&
                    ((r = !0), b > a && (s = "onReverseComplete")),
                  (_._rawPrevTime = p = !e || t || b === t ? t : a)))
              : a > t
              ? ((_._totalTime = _._time = _._cycle = 0),
                (_.ratio = _._ease._calcEnd ? _._ease.getRatio(0) : 0),
                (0 !== v || (0 === w && b > 0)) &&
                  ((s = "onReverseComplete"), (n = _._reversed)),
                t > -a
                  ? (t = 0)
                  : 0 > t &&
                    ((_._active = !1),
              ...
              : ((_._totalTime = _._time = t),
                0 !== _._repeat &&
                  ((u = w + _._repeatDelay),
                  (_._cycle = (_._totalTime / u) >> 0),
                  0 !== _._cycle &&
                    _._cycle === _._totalTime / u &&
                    t >= v &&
                    _._cycle--,
                  (_._time = _._totalTime - _._cycle * u),
                  _._yoyo &&
                    0 != (1 & _._cycle) &&
                    ((_._time = w - _._time),
                    (d = _._yoyoEase || _.vars.yoyoEase) &&
                      (_._yoyoEase ||
                        (!0 !== d || _._initted
                          ? (_._yoyoEase = d =
                              !0 === d
                            ...
                            (_._yoyoEase = d =
                              d
                                ? d instanceof Ease
                                  ? d
                                  : "function" == typeof d
                                  ? new Ease(d, _.vars.easeParams)
                                  : Ease.map[d] || i.defaultEase
                                : i.defaultEase))),
                      (_.ratio = d ? 1 - d.getRatio((w - _._time) / w) : 0))),
                  _._time > w ? (_._time = w) : _._time < 0 && (_._time = 0)),
                _._easeType && !d
                  ? ((c = _._time / w),
                    (1 === (h = _._easeType) || (3 === h && c >= 0.5)) &&
                      (c = 1 - c),
                    3 === h && (c *= 2),
                    1 === (f = _._easePower)
                      ? (c *= c)
                    ...
                    (_.ratio =
                      1 === h
                        ...
                        ? c / 2
                        : 1 - c / 2))
                  : d || (_.ratio = _._ease.getRatio(_._time / w))),
            g !== _._time || r || y !== _._cycle)
          ) {
            if (!_._initted) {
              ...
              !_._time || n || d
                ...
                : (_.ratio = _._ease.getRatio(_._time / w));
            }
            for (
              !1 !== _._lazy && (_._lazy = !1),
                _._active ||
                  (!_._paused && _._time !== g && t >= 0 && (_._active = !0)),
                0 === v &&
                  (2 === _._initted && t > 0 && _._init(),
                  _._startAt &&
                    (t >= 0
                      ? _._startAt.render(t, !0, r)
                      : s || (s = "_dummyGS")),
                  _.vars.onStart &&
                    (0 !== _._totalTime || 0 === w) &&
                    (e || _._callback("onStart"))),
                o = _._firstPT;
              o;

            )
              o.f
                ? o.t[o.p](o.c * _.ratio + o.s)
                : (o.t[o.p] = o.c * _.ratio + o.s),
                (o = o._next);
            _._onUpdate &&
              (0 > t &&
                ...
                _._startTime &&
                _._startAt.render(t, !0, r),
              e || ((_._totalTime !== v || s) && _._callback("onUpdate"))),
              _._cycle !== y &&
                (e || _._gc || (_.vars.onRepeat && _._callback("onRepeat"))),
              s &&
                (!_._gc || r) &&
                (0 > t &&
                  _._startAt &&
            ...
            v !== _._totalTime && _._onUpdate && (e || _._callback("onUpdate"));
        }),
        (o.to = function (t, e, i) {
          return new o(t, e, i);
        }),
        ...
        (o.staggerTo = o.allTo =
          function (t, e, a, l, h, p, d) {
            ...
            for (
              ...
              (m.delay = w(g, t[g], t) + (m.delay || 0)),
                g === _ &&
                  h &&
                  (m.onComplete = function () {
                    a.onComplete &&
                      a.onComplete.apply(a.onCompleteScope || this, arguments),
                      h.apply(d || a.callbackScope || this, p || f);
                  }),
                (y[g] = new o(t[g], e, m));
            }
            return y;
        ...
        (o.staggerFrom = o.allFrom =
          function (t, e, i, r, n, s, a) {
            return (
              (i.runBackwards = !0),
              (i.immediateRender = 0 != i.immediateRender),
              o.staggerTo(t, e, i, r, n, s, a)
            );
          }),
        (o.staggerFromTo = o.allFromTo =
          function (t, e, i, r, n, s, a, l) {
            return (
              (r.startAt = i),
              (r.immediateRender =
                0 != r.immediateRender && 0 != i.immediateRender),
              o.staggerTo(t, e, r, n, s, a, l)
            );
          }),
      ...
      var p = function (t, e) {
          for (var r = [], n = 0, s = t._first; s; )
            s instanceof i
              ? (r[n++] = s)
              : (e && (r[n++] = s), (n = (r = r.concat(p(s, e))).length)),
              (s = s._next);
          return r;
        },
        ...
        (o.killChildTweensOf = function (t, e) {
          if (null != t) {
            ...
            if (
              ...
              for (a in ((n = []), p))
                for (s = p[a].target.parentNode; s; )
                  s === t && (n = n.concat(p[a].tweens)), (s = s.parentNode);
      ...
      var _ = function (t, i, r, n) {
        (i = !1 !== i), (r = !1 !== r);
        for (
          var s, o, a = d((n = !1 !== n)), l = i && r && n, u = a.length;
          --u > -1;
      ...
      function (t, e, i) {
        ...
        return (
          ...
          (g.from = function (t, e, r, n) {
            return this.add(
              ((r.repeat && h.TweenMax) || i).from(t, e, _(0, r)),
              n
            );
          }),
          ...
          (g.staggerTo = function (t, e, n, s, o, l, u, c) {
            ...
            for (
              ...
              (h = f(n)),
                v && ((h.startAt = f(v)), v.cycle && p(h.startAt, t, d)),
                y &&
                  (p(h, t, d),
                  null != h.duration && ((e = h.duration), delete h.duration)),
                _.to(t[d], e, h, g(d, t[d], t));
            return this.add(_, o);
          }),
          (g.staggerFrom = function (t, e, i, r, n, s, o, a) {
            return (
              (i.runBackwards = !0),
              this.staggerTo(t, e, _(0, i), r, n, s, o, a)
            );
          }),
          (g.staggerFromTo = function (t, e, i, r, n, s, o, a, l) {
            return (
              (r.startAt = i), this.staggerTo(t, e, _(0, r, i), n, s, o, a, l)
            );
          }),
            ...
            for (
              ...
              (a = o._next),
                (e && o instanceof i && o.target === o.vars.onComplete) ||
                  (0 > (s = o._startTime - o._delay) && (n = 1), l.add(o, s)),
                (o = a);
          ...
          (g.add = function (n, s, o, a) {
            ...
            if (
              ...
              if (n instanceof Array || (n && n.push && l(n))) {
                for (
                  o = o || "normal", a = a || 0, u = s, c = n.length, h = 0;
                  c > h;
                  h++
                )
            ...
            if (
              ...
              for (d = (p = _).rawTime() > n._startTime; p._timeline; )
          ...
          (g._parseTimeOrLabel = function (e, i, r, n) {
            ...
            if (
              ...
              (i =
                ...
                (e =
                  o > 1 ? this._parseTimeOrLabel(e.substr(0, o - 1), 0, r) : s);
            }
            return Number(e) + i;
          }),
          (g.seek = function (t, e) {
          ...
          (g.render = function (t, e, i) {
            ...
            var r,
              ...
              y = d._paused;
            if (
              (_ !== d._time && (t += d._time - _),
              d._hasPause && !d._forcingPlayhead && !e)
            ) {
              if (t > _)
                for (r = d._first; r && r._startTime <= t && !h; )
                  r._duration ||
                    "isPause" !== r.data ||
                    r.ratio ||
                ...
                for (r = d._last; r && r._startTime >= t && !h; )
                  r._duration ||
                    ("isPause" === r.data && r._rawPrevTime > 0 && (h = r)),
                    (r = r._prev);
              h &&
                ((d._time = d._totalTime = t = h._startTime),
                (p =
                  d._startTime +
            ...
            if (t >= m - n && t >= 0)
              (d._totalTime = d._time = m),
                d._reversed ||
                  ...
                  0 === d._duration &&
                    ...
                    d._first &&
                    ((l = !0),
                    d._rawPrevTime > n && (a = "onReverseComplete"))),
                (d._rawPrevTime =
              ...
              if (
                ...
                (0 !== _ ||
                  (0 === d._duration &&
                    d._rawPrevTime !== n &&
                    (d._rawPrevTime > 0 || (0 > t && d._rawPrevTime >= 0)))) &&
                  ((a = "onReverseComplete"), (s = d._reversed)),
                0 > t)
              )
                (d._active = !1),
            ...
            if ((d._time !== _ && d._first) || i || l || h) {
              if (
                ...
                d._active ||
                  (!d._paused && d._time !== _ && t > 0 && (d._active = !0)),
                0 === _ &&
                  d.vars.onStart &&
                ...
                for (
                  r = d._first;
                  r && ((o = r._next), f === d._time && (!d._paused || y));

                )
                  (r._active || (r._startTime <= f && !r._paused && !r._gc)) &&
                    (h === r && (d.pause(), (d._pauseTime = p)),
                    r._reversed
                      ? r.render(
                ...
                for (
                  r = d._last;
                  r && ((o = r._prev), f === d._time && (!d._paused || y));
                  ...
                  if (
                    ...
                    if (h === r) {
                      for (h = r._prev; h && h.endTime() > d._time; )
                        h.render(
                          h._reversed
                            ? h.totalDuration() -
              ...
              d._onUpdate && (e || (u.length && c(), d._callback("onUpdate"))),
                a &&
                  (d._gc ||
                    ((g === d._startTime || v !== d._timeScale) &&
                      (0 === d._time || m >= d.totalDuration()) &&
                      (s &&
                        (u.length && c(),
                        d._timeline.autoRemoveChildren && d._enabled(!1, !1),
                        (d._active = !1)),
                      !e && d.vars[a] && d._callback(a))));
            }
          }),
        ...
        return (
          ...
          (c.render = function (t, e, i) {
            ...
            var r,
              ...
              T = _._paused,
              A = _._cycle;
            if ((m !== _._time && (t += _._time - m), t >= g - n && t >= 0))
              _._locked || ((_._totalTime = g), (_._cycle = _._repeat)),
                _._reversed ||
                  _._hasPausedChild() ||
                  ((s = !0),
                  (u = "onComplete"),
                  ...
                  0 === _._duration &&
                    ...
                    x !== t &&
                    _._first &&
                    ((c = !0), x > n && (u = "onReverseComplete"))),
                (_._rawPrevTime =
                  _._duration || !e || t || _._rawPrevTime === t ? t : n),
                _._yoyo && 1 & _._cycle
                  ? (_._time = t = 0)
                  : ((_._time = v), (t = v + 1e-4));
            else if (n > t)
              if (
                ...
                (0 !== m ||
                  (0 === v &&
                    ...
                    (x > 0 || (0 > t && x >= 0)) &&
                    !_._locked)) &&
                  ((u = "onReverseComplete"), (s = _._reversed)),
                0 > t)
              )
                (_._active = !1),
                  _._timeline.autoRemoveChildren && _._reversed
                    ? ((c = s = !0), (u = "onReverseComplete"))
                    : x >= 0 && _._first && (c = !0),
                  (_._rawPrevTime = t);
              else {
                if (
                  ((_._rawPrevTime =
                    v || !e || t || _._rawPrevTime === t ? t : n),
                  0 === t && s)
                )
              ...
              0 === v && 0 > x && (c = !0),
                ...
                _._locked ||
                  ...
                  0 !== _._repeat &&
                    ((h = v + _._repeatDelay),
                    (_._cycle = (_._totalTime / h) >> 0),
                    _._cycle &&
                      _._cycle === _._totalTime / h &&
                      t >= y &&
                      _._cycle--,
                    (_._time = _._totalTime - _._cycle * h),
                    _._yoyo && 1 & _._cycle && (_._time = v - _._time),
                    _._time > v
                      ? ((_._time = v), (t = v + 1e-4))
                      : _._time < 0
                      ? (_._time = t = 0)
            ...
            if (_._hasPause && !_._forcingPlayhead && !e) {
              if ((t = _._time) > m || (_._repeat && A !== _._cycle))
                for (r = _._first; r && r._startTime <= t && !f; )
                  r._duration ||
                    "isPause" !== r.data ||
                    r.ratio ||
                ...
                for (r = _._last; r && r._startTime >= t && !f; )
                  r._duration ||
              ...
              f &&
                ((d =
                  _._startTime +
                  (_._reversed ? _._duration - f._startTime : f._startTime) /
                    _._timeScale),
                f._startTime < v &&
                  ((_._time = _._rawPrevTime = t = f._startTime),
                  (_._totalTime =
            ...
            if (_._cycle !== A && !_._locked) {
              ...
              if (
                ((_._totalTime = A * v),
                _._cycle < A ? (S = !S) : (_._totalTime += v),
                (_._time = m),
                (_._rawPrevTime = 0 === v ? x - 1e-4 : x),
                (_._cycle = A),
                (_._locked = !0),
                (m = S ? 0 : v),
                _.render(m, e, 0 === v),
            ...
            if ((_._time !== m && _._first) || i || c || f) {
              if (
                ...
                for (
                  r = _._first;
                  r && ((l = r._next), p === _._time && (!_._paused || T));

                )
                  (r._active ||
                    (r._startTime <= _._time && !r._paused && !r._gc)) &&
                    (f === r && (_.pause(), (_._pauseTime = d)),
                    r._reversed
                      ? r.render(
                          (r._dirty ? r.totalDuration() : r._totalDuration) -
                            (t - r._startTime) * r._timeScale,
                ...
                for (
                  r = _._last;
                  r && ((l = r._prev), p === _._time && (!_._paused || T));
                  ...
                  if (
                    ...
                    if (f === r) {
                      for (f = r._prev; f && f.endTime() > _._time; )
                        f.render(
                          f._reversed
                            ? f.totalDuration() -
              ...
              _._onUpdate && (e || (o.length && a(), _._callback("onUpdate"))),
                u &&
                  (_._locked ||
                    _._gc ||
                    ((w === _._startTime || b !== _._timeScale) &&
                      (0 === _._time || g >= _.totalDuration()) &&
                      (s &&
                        (o.length && a(),
                        _._timeline.autoRemoveChildren && _._enabled(!1, !1),
                        (_._active = !1)),
                      !e && _.vars[u] && _._callback(u))));
            } else
              y !== _._totalTime &&
                _._onUpdate &&
    ...
    (l = function (t, n, s, o, l) {
      ...
      for (u = 0; x > u; u++)
        (c = (p = t[T]).a),
          ...
          l
            ? ((y = e[u]),
              (b = (((w = i[u]) + y) * n * 0.25) / (o ? 0.5 : r[u] || 0.5)),
              (m =
                h -
                ((d = h - (h - c) * (o ? 0.5 * n : 0 !== y ? b / y : 0)) +
                  ((((_ = h + (f - h) * (o ? 0.5 * n : 0 !== w ? b / w : 0)) -
                    d) *
                    ((3 * y) / (y + w) + 0.5)) /
                    4 || 0))))
            : (m =
                h -
                ((d = h - (h - c) * n * 0.5) + (_ = h + (f - h) * n * 0.5)) /
                  2),
          (d += m),
          (_ += m),
          (p.c = g = d),
      ...
      ((p = t[T]).b = A),
        ...
        (p.ba = A - p.a),
        s &&
          ((v = a(p.a, A, p.c, p.d)), t.splice(T, 1, v[0], v[1], v[2], v[3]));
    }),
    (u = function (t, r, n, s) {
      var a,
        l,
      ...
      if (0 > (a = t.length - 2))
        return (p[0] = new o(t[0][r], 0, 0, t[0][r])), p;
      for (l = 0; a > l; l++)
        (u = t[l][r]),
          (c = t[l + 1][r]),
          (p[l] = new o(u, 0, 0, c)),
    ...
    (c = function (t, s, o, a, c, h) {
      ...
      if (!a) {
        for (f = b.length; --f > -1; )
          if (n[p])
            for (g = (d = w[b[f]]).length - 1, _ = 0; g > _; _++)
    ...
    (h = function (t, e, i) {
      ...
      for (u = v.length; --u > -1; ) {
        for (_[(f = v[u])] = l = [], p = 0, h = t.length, c = 0; h > c; c++)
          (r =
            null == i
              ? t[c][f]
    ...
    (f = function (t, e, i) {
      for (
        var r, n, s, o, a, l, u, c, h, f, p, d = 1 / i, _ = t.length;
        --_ > -1;
        ...
        if (this._autoRotate) {
          ...
          for (n = A.length; --n > -1; )
            (s = A[n][2]),
              ...
              (g = this._beziers[A[n][1]]),
              o &&
                g &&
                ((o = o[i]),
                (g = g[i]),
                (v = o.a + (o.b - o.a) * a),
                (v += ((w = o.b + (o.c - o.b) * a) - v) * a),
                (w += (o.c + (o.d - o.c) * a - w) * a),
                (y = g.a + (g.b - g.a) * a),
                (y += ((b = g.b + (g.c - g.b) * a) - y) * a),
                (b += (g.c + (g.d - g.c) * a - b) * a),
                (l = m
                  ? Math.atan2(b - y, w - v) * T + x
    ...
    _gsScope._gsDefine(
      ...
      function (t, e) {
        ...
        var c,
          ...
          V = (function () {
            ...
            return (
              ...
              (d = f && parseFloat(Y.substr(Y.indexOf("Version/") + 8, 2)) < 6),
          ...
          J =
            "undefined" != typeof window
              ? window
              : X.defaultView || { getComputedStyle: function () {} },
          tt = function (t) {
          ...
          rt = (Q.calculateOffset = function (t, e, i) {
            ...
            var r = "left" === e ? "Left" : "Top",
              n = et(t, "margin" + r, i);
            return (
              t["offset" + r] - (it(t, e, parseFloat(n), n.replace(T, "")) || 0)
            );
          }),
          nt = function (t, e) {
            var i,
              ...
              if ((i = e.length))
                for (; --i > -1; )
                  (-1 === (n = e[i]).indexOf("-transform") || Et === n) &&
                    (s[n.replace(C, E)] = e.getPropertyValue(n));
              else
                for (i in e)
                  (-1 === i.indexOf("Transform") || Rt === i) && (s[i] = e[i]);
        ...
        var vt = function (t, e, i, r) {
          ...
          Tt = (o.parseComplex = function (t, e, i, r, n, s, a, l, u, h) {
            (i = i || s || ""),
              ...
              (a = new bt(t, e, 0, 0, a, h ? 2 : 1, null, !1, l, i, r)),
              (r += ""),
              n &&
                gt.test(r + i) &&
            ...
            for (
              ...
              if (((_ = C[f]), (w = R[f] + ""), (T = parseFloat(_)) || 0 === T))
                a.appendXtra(
                  "",
                  T,
                  ct(w, T),
                ...
                for (d = 0, p = 0; p < b.length; p++)
                  (P = b[p]),
                    ...
                    a.appendXtra(
                      ...
                      ct(x[p], P),
                      "",
                      !(!I || "px" !== _.substr(S + P.length, 2)) && Math.round,
                      0 === p
                    ),
                    (d = S + P.length);
                a["xs" + a.l] += _.substr(d);
          ...
          At = 9;
        for ((u = bt.prototype).l = u.pr = 0; --At > 0; )
          (u["xn" + At] = 0), (u["xs" + At] = "");
        (u.xs0 = ""),
          (u._next =
            u._prev =
            ...
            u.rxp =
              null),
          (u.appendXtra = function (t, e, i, r, n, s) {
            var o = this,
              a = o.l;
            return (
            ...
            if (!l[t]) {
              ...
              Pt(t, {
                parser: function (t, i, r, n, s, o, u) {
                  ...
                  return c
                    ? (c._cssRegister(), l[r].parse(t, i, r, n, s, o, u))
                    : ($("Error: " + e + " js file not loaded."), s);
                },
              });
            }
          });
        ...
        var Ot,
          ...
          Ft = function (t, e, i) {
            var r,
              n = X.createElementNS("http://www.w3.org/2000/svg", t),
              s = /([a-z])([A-Z])/g;
            for (r in i)
          ...
          jt = (function () {
            var t,
              e,
              i,
              r = _ || (/Android/i.test(Y) && !_gsScope.chrome);
            return (
              X.createElementNS &&
                Lt.appendChild &&
                !r &&
                ...
                (r = i === e.getBoundingClientRect().width && !(p && Mt)),
                Lt.removeChild(t)),
              r
            );
          })(),
          Nt = function (t, e, i, r, n, s) {
            ...
            b && ((y = b.xOrigin), (w = b.yOrigin)),
              ...
              r &&
                ...
                (g = x[5]),
                (v = f * _ - p * d) &&
                  ((l = c * (_ / v) + h * (-d / v) + (d * g - _ * m) / v),
                  (u = c * (-p / v) + h * (f / v) - (f * g - p * m) / v),
                  (c = i.xOrigin = a[0] = l),
                  (h = i.yOrigin = a[1] = u))),
              b &&
                (s &&
          ...
          Ut = function (t, e) {
            ...
            if (
              (Rt
                ...
                : t.currentStyle &&
                  (r =
                    (r = t.currentStyle.filter.match(M)) && 4 === r.length
                      ? [
                          r[0].substr(4),
                          Number(r[2].substr(4)),
                          Number(r[1].substr(4)),
              ...
              Rt &&
                ...
                ((l = t.parentNode) && t.offsetParent) ||
                  ((o = 1), (a = t.nextSibling), Lt.appendChild(t)),
                (i =
                  !(r = et(t, Et, null, !0)) ||
                  "none" === r ||
                  "matrix(1, 0, 0, 1, 0, 0)" === r),
                s ? (h.display = s) : Ht(h, "display"),
                o &&
                  (a
                    ? l.insertBefore(t, a)
                    : l
              ...
              return qt;
            for (n = (r || "").match(v) || [], At = n.length; --At > -1; )
              (s = Number(n[At])),
                (n[At] = (o = s - (s |= 0))
                  ? ((o * c + (0 > o ? -0.5 : 0.5)) | 0) / c + s
                  : s);
            return e && n.length > 6
            ...
            if (
              ...
              if (16 === s.length) {
                var v,
                  ...
                  N = Math.atan2(C, M);
                f.zOrigin &&
                  ((z = E * (F = -f.zOrigin) - s[12]),
                  (D = I * F - s[13]),
                  (F = M * F + f.zOrigin - s[14])),
                  (f.rotationX = N * j),
                  N &&
                    ((v = k * (b = Math.cos(-N)) + E * (x = Math.sin(-N))),
                    (y = O * b + I * x),
                    (w = C * b + M * x),
                    (E = k * -x + E * b),
                    (I = O * -x + I * b),
                  ...
                  (f.rotationY = N * j),
                  N &&
                    ((y = A * (b = Math.cos(-N)) - I * (x = Math.sin(-N))),
                    (w = S * b - M * x),
                    (I = A * x + I * b),
                    (M = S * x + M * b),
                    (L = P * x + L * b),
                  ...
                  (f.rotation = N * j),
                  N &&
                    ((v = T * (b = Math.cos(N)) + A * (x = Math.sin(N))),
                    (y = k * b + O * x),
                    (w = E * b + I * x),
                    (A = A * b - T * x),
                    (O = O * b - k * x),
                  ...
                  (N = Math.atan2(k, O)),
                  (f.scaleX =
                    ((Math.sqrt(T * T + A * A + S * S) * _ + 0.5) | 0) / _),
                  (f.scaleY = ((Math.sqrt(O * O + C * C) * _ + 0.5) | 0) / _),
                  (f.scaleZ =
                    ((Math.sqrt(E * E + I * I + M * M) * _ + 0.5) | 0) / _),
                  (T /= f.scaleX),
                  (k /= f.scaleY),
                  (A /= f.scaleX),
                  (O /= f.scaleY),
                ...
                (f.x = s[4] || 0),
                  ...
                  (l = Math.sqrt(X * X + q * q)),
                  (u = Math.sqrt(W * W + U * U)),
                  (c = X || q ? Math.atan2(q, X) * j : f.rotation || 0),
                  (h = U || W ? Math.atan2(U, W) * j + c : f.skewX || 0),
                  (f.scaleX = l),
                  (f.scaleY = u),
                  (f.rotation = c),
                  (f.skewX = h),
                  Mt &&
                    ...
                    (f.scaleZ = 1)),
                  f.svg &&
                    ((f.x -= f.xOrigin - (f.xOrigin * X + f.yOrigin * U)),
                    (f.y -= f.yOrigin - (f.xOrigin * q + f.yOrigin * W)));
              }
              ...
              if (
                ...
                (0 === t || 1 === t) &&
                  ...
                  ((v && -1 === y.indexOf("Dx=0, Dy=0")) ||
                    (A.test(e) && 100 !== parseFloat(RegExp.$1)) ||
                ...
                for (
                  ...
                  (P =
                    (i =
                      -1 !== (x = f[(S = at[At])]).indexOf("px")
                        ? parseFloat(x)
                        : it(this.t, S, parseFloat(x), x.replace(T, "")) ||
                          0) !== r[S]
                      ? 2 > At
                        ? -r.ieOffsetX
                        : -r.ieOffsetY
                ...
                if (
                  ...
                  (c = 1),
                    ...
                    (k = C * L) &&
                      ...
                      (s *= g)),
                    (k = O * L) &&
                      ((e = r * (g = Math.cos(k)) + n * (v = Math.sin(k))),
                      (y = o * g + a * v),
                      (u = c * v),
                      (f = d * v),
                      (n = r * -v + n * g),
        ...
        ((u = zt.prototype).x =
                ...
                return (
                  (C =
                    "function" == typeof S.transformOrigin
                      ? S.transformOrigin(g, m)
                      : S.transformOrigin),
                  O.svg &&
                    (C || S.svgOrigin) &&
                    ((_ = O.xOffset),
                    (v = O.yOffset),
                    Nt(t, ut(C), c, S.svgOrigin, S.smoothOrigin),
                    (s = xt(
                      O,
                      "xOrigin",
                      (b ? O : c).xOrigin,
                      ...
                      ? ((p = !0),
                        ...
                        C ||
                          (C =
                            ...
                            "px"),
                        (C += ""),
                        ((s = new bt(x, w, 0, 0, s, -1, k)).b = x[w]),
                        (s.plugin = a),
                        Mt
                          ? ((h = O.zOrigin),
                            (C = C.split(" ")),
                            (O.zOrigin =
                              (C.length > 2 ? parseFloat(C[2]) : h) || 0),
                            (s.xs0 = s.e =
                              C[0] + " " + (C[1] || "50%") + " 0px"),
                            ((s = new bt(O, "zOrigin", 0, 0, s, -1, s.n)).b =
                              h),
                            (s.xs0 = s.e = O.zOrigin))
                          : (s.xs0 = s.e = C))
                      : ut(C + "", O)),
          ...
          Pt("borderRadius", {
            ...
            parser: function (t, e, i, s, o, a) {
              ...
              for (
                ...
                this.p.indexOf("border") && (A[u] = K(A[u])),
                  -1 !== (f = h = et(t, A[u], n, !1, "0px")).indexOf(" ") &&
                  ...
                  "" === v && (v = r[i] || y),
                  v !== y &&
                    ((b = it(t, "borderLeft", d, y)),
                    (x = it(t, "borderTop", d, y)),
                    "%" === v
                      ? ((f = (b / m) * 100 + "%"), (h = (x / g) * 100 + "%"))
                      : "em" === v
                      ? ((f = b / (T = it(t, "borderLeft", 1, "em")) + "em"),
                        (h = x / T + "em"))
                      : ((f = b + "px"), (h = x + "px")),
                    w &&
                      ((p = parseFloat(f) + _ + v),
                      (c = parseFloat(h) + _ + v))),
                  (o = Tt(S, A[u], f + " " + h, p + " " + c, !1, "0px", o));
              return o;
            },
            prefix: !0,
          ...
          Pt("backgroundPosition", {
            ...
            parser: function (t, e, i, r, s, o) {
              ...
              if (
                ...
                g.split(",").length < 2 &&
                (f = et(t, "backgroundImage").replace(R, "")) &&
                "none" !== f
              ) {
                for (
                  a = m.split(" "),
            ...
            parser: function (t, e, i, r, s, o) {
              ...
              return (
                9 > _
                  ...
                  : ((a = this.format(et(t, this.p, n, !1, this.dflt))),
                    (e = this.format(e))),
          ...
          Pt("border", {
            ...
            parser: function (t, e, i, r, s, o) {
              ...
              return (
                "px" !== u &&
                  (a = parseFloat(a) / it(t, "borderTopWidth", 1, u) + u),
                this.parseComplex(
                  t.style,
                  this.format(
                    a +
          ...
          100 === n &&
            ...
            e ||
              ...
              -1 === r.indexOf("pacity")
                ...
                : (i.filter = r.replace(A, "opacity=" + n)));
        };
          ...
          parser: function (t, e, i, r, s, o) {
            ...
            return (
              ...
              V
                ...
                : (((s = new bt(l, "opacity", 100 * a, 100 * (e - a), s)).xn1 =
                    u ? 1 : 0),
                  (l.zoom = 1),
                  (s.type = 2),
        ...
        Pt("className", {
          parser: function (t, e, r, s, o, a, l) {
            var u,
              ...
              _ = t.style.cssText;
            if (
              (((o = s._classNamePT = new bt(t, r, 0, 0, o, 2)).setRatio = $t),
              (o.pr = -11),
              (i = !0),
              (o.b = d),
              (c = nt(t, n)),
            ...
            return (
              ...
              (o.data = u.firstMPT),
              t.style.cssText !== _ && (t.style.cssText = _),
        ...
        for (
          Pt("clearProps", {
            parser: function (t, e, r, n, s) {
              return (
                ((s = new bt(t, r, 0, 0, s, 2)).setRatio = Gt),
                (s.e = e),
                (s.pr = -10),
                (s.data = n._tween),
                (i = !0),
          ...
          (u._onInitTween = function (t, e, a, u) {
            ...
            if (
              ...
              "string" == typeof e &&
                ...
                (P.cssText = y + ";" + e),
                (p = st(t, p, nt(t)).difs),
                !V && S.test(e) && (p.opacity = parseFloat(RegExp.$1)),
                (e = p),
                (P.cssText = y)),
              e.className
                ? (this._firstPT = _ =
              ...
              (T = new bt(t, "transform", 0, 0, null, 2)),
                ...
                (T.setRatio = Rt ? Yt : Qt),
                (T.data = this._transform || Wt(t, n, !0)),
                (T.tween = a),
                (T.pr = -1),
                s.pop();
            }
          ...
          (u.parse = function (t, e, i, s) {
            ...
            for (o in e) {
              if (
                ((p = e[o]),
                (a = l[o]),
                "function" != typeof p || (a && a.allowFunc) || (p = p(g, m)),
                a)
              )
                ...
                (f = et(t, o, n) + ""),
                  ...
                  (v && k.test(p))
                    ? (v ||
                        (p =
                          ((p = _t(p)).length > 3 ? "rgba(" : "rgb(") +
                          p.join(",") +
                          ")"),
                      (i = Tt(w, o, f, p, !0, "transparent", i, 0, s)))
                    : v && F.test(p)
                    ? (i = Tt(w, o, f, p, !0, null, i, 0, s))
                    : ((d =
                        (u = parseFloat(f)) || 0 === u
                          ? f.substr((u + "").length)
                          : ""),
    ...
    _gsScope._gsDefine(
      ...
      function (t) {
        ...
        return (
          ...
          ((g = e.prototype = new t()).constructor = e),
          (g.getRatio = function (t) {
            return (
          ...
          ((g = r.prototype = new t()).constructor = r),
          (g.getRatio = function (t) {
            var e = this._prev;
            if (t > e.t) {
  ...
  (function (t, e) {
    ...
    var o,
      ...
      v = function (r, s, o, a) {
        ...
        (this.check = function (u) {
          for (var c, f, p, d, _ = s.length, m = _; --_ > -1; )
            (c = g[s[_]] || new v(s[_], [])).gsClass
              ? ((l[_] = c.gsClass), m--)
              : u && c.sc.push(this);
          if (0 === m && o) {
            if (
              ((p = (f = ("com.greensock." + r).split(".")).pop()),
              (d = h(f.join("."))[p] = this.gsClass = o.apply(o, l)),
              a)
            )
              if (
                ((n[p] = i[p] = d),
    ...
    var b = [0, 0, 1, 1],
      ...
      A = (x.register = function (t, e, i, r) {
        for (
          ...
          for (
            s = l[u],
              n = r ? w("easing." + s, null, !0) : f.easing[s] || {},
              o = c.length;
            --o > -1;
    ...
    for (
      ...
      (l = o[a] + ",Power" + a),
        A(new x(null, null, 1, a), l, "easeOut", !0),
        A(new x(null, null, 2, a), l, "easeIn" + (0 === a ? ",easeNone" : "")),
        A(new x(null, null, 3, a), l, "easeInOut");
    ...
    var P = t.requestAnimationFrame,
      ...
      C = O();
    for (a = (o = ["ms", "moz", "webkit", "o"]).length; --a > -1 && !P; )
      (P = t[o[a] + "RequestAnimationFrame"]),
        (k =
    ...
    (u = R.ticker = new f.Ticker()),
      ((l = R.prototype)._dirty = l._gc = l._initted = l._paused = !1),
    ...
    var E = function () {
      c &&
        O() - C > 2e3 &&
        ("hidden" !== (r || {}).visibilityState || !u.lagSmoothing()) &&
        u.wake();
        ...
        if (this._timeline) {
          ...
          this._gc && this._enabled(!0, !1),
            (this._totalTime !== t || 0 === this._duration) &&
              (D.length && K(), this.render(t, e, !1), D.length && K());
        }
        return this;
      }),
    ...
    ((l = I.prototype = new R()).constructor = I),
      (l.kill()._gc = !1),
    ...
    var M = w(
        ...
        function (e, i, r) {
          if (
            (R.call(this, i, r), (this.render = M.prototype.render), null == e)
          )
              ...
              (s = o[n])
                ? "string" != typeof s
                  ? s.length &&
                    ...
                    : ((this._siblings[n] = J(s, this, !1)),
                      1 === l &&
                        this._siblings[n].length > 1 &&
                        et(s, this, null, 1, this._siblings[n]))
                  : "string" == typeof (s = o[n--] = M.selector(s)) &&
                    o.splice(n + 1, 1)
                : o.splice(n--, 1);
          else
            (this._propLookup = {}),
      ...
      X = function (t, e, i, r) {
        ...
        for (
          h.start = t,
            ...
            s = e.match(L) || [],
            r &&
              ((r._next = null), (r.blob = 1), (h._firstPT = h._applyPT = r)),
            l = s.length,
            a = 0;
          l > a;
          a++
        ...
        return (
          ("number" != typeof h || ("number" != typeof r && !f)) &&
            ...
            "boolean" == typeof r
              ...
              : ((p.s = parseFloat(h)), f || (p.c = parseFloat(r) - p.s || 0))),
          p.c
      ...
      (R._updateRoot = M.render =
        function () {
          ...
          if (
            ...
            for (i in ((Z = u.frame + (parseInt(M.autoSleep, 10) || 120)), Q)) {
        ...
        for (s = n.length; --s > -1; )
          (a = n[s]) === e ||
            ...
            (a._timeline !== e._timeline
              ? ((u = u || it(e, 0, d)), 0 === it(a, u, d) && (h[f++] = a))
              : a._startTime <= c &&
                a._startTime + a.totalDuration() / a._timeScale > c &&
                (((d || !a._initted) && c - a._startTime <= 2 * p) ||
                  (h[f++] = a)));
        for (s = f; --s > -1; )
          if (
            ((l = (a = h[s])._firstPT),
    ...
    (l._init = function () {
      var t,
        ...
        h = this._startAt;
      if (o.startAt) {
        for (r in (h && (h.render(-1, !0), h.kill()), (n = {}), o.startAt))
          n[r] = o.startAt[r];
        if (
          ((n.data = "isStart"),
          (n.overwrite = !1),
      ...
      (l.render = function (t, e, i) {
        ...
        if (t >= u - p && t >= 0)
          (a._totalTime = a._time = u),
            ...
            0 === u &&
              ...
              (0 > c ||
                ...
                (c === p && "isPause" !== a.data)) &&
                c !== t &&
                ((i = !0), c > p && (n = "onReverseComplete")),
              (a._rawPrevTime = o = !e || t || c === t ? t : p));
        else if (p > t)
          ...
          (1 === f || (3 === f && h >= 0.5)) && (h = 1 - h),
            ...
            1 === d
              ...
              : 4 === d && (h *= h * h * h * h),
            (a.ratio =
              1 === f ? 1 - h : 2 === f ? h : 0.5 > t / u ? h / 2 : 1 - h / 2);
        ...
        if (a._time !== l || i) {
          ...
          for (
            !1 !== a._lazy && (a._lazy = !1),
              a._active ||
                (!a._paused && a._time !== l && t >= 0 && (a._active = !0)),
              0 === l &&
                (a._startAt &&
                  (t >= 0
            ...
            s.f
              ...
              (s = s._next);
          a._onUpdate &&
            (0 > t && a._startAt && -1e-4 !== t && a._startAt.render(t, !0, i),
            e || ((a._time !== l || r || i) && a._callback("onUpdate"))),
            n &&
              (!a._gc || i) &&
              (0 > t &&
                a._startAt &&
